...
fun main() {
    val input = readResource("day09/input.txt")

    println("Part 1: ${part1(input)}")
    println("Part 2: ${part2(input)}")
}

fun part1(input: String): Long = packDisk(parseInput(input).toMutableList()).computeChecksum()

fun part2(input: String): Long = defragmentDisk(parseInput(input).toMutableList()).computeChecksum()
